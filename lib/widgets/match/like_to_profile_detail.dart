...
class LikeToProfileDetail extends StatefulWidget {
  final RecommendProfileModel profile;

  const LikeToProfileDetail(this.profile, {super.key});

  @override
  State<LikeToProfileDetail> createState() => _LikeToProfileDetailState();
}

class _LikeToProfileDetailState extends State<LikeToProfileDetail> {
                    ...
                    child: Column(
                      children: [
                        SizedBox(
                          ...
                          child: Stack(children: [
                            ...
                            Positioned(
                              ...
                              child: Padding(
                                padding:
                                    const EdgeInsets.only(right: 30, bottom: 0),
                                child: IconButton(
                                  onPressed: () {
                                    Navigator.of(context).pop();
                                  },
                        ...
                        if (widget.profile.mbti != null ||
                            widget.profile.interest != null ||
                            widget.profile.hobby != null)
                          const Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: 40, vertical: 15),
                            child: Divider(
                            ...
                            child: Align(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  for (var i = 0;
                                      i < widget.profile.interest!.length;
                                      i++)
