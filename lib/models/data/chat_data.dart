...
List<ChatData> chatDataList = [
  ...
  ChatData(chatId: 0, isSender: true, message: '내가 보낸 메시지', sendTime: DateTime(2023, 7, 8, 10, 14, 32, 50), isCheck: true),
  ChatData(chatId: 1, isSender: true, message: '내가 보낸 메시지2', sendTime: DateTime(2023, 7, 8, 10, 14, 34, 50), isCheck: true),
  ...
  ChatData(chatId: 11, isSender: true, message: 'ㅇ', sendTime: DateTime(2023, 7, 8, 12, 19, 35, 50), isCheck: true),
  ChatData(chatId: 12, isSender: false, message: '스크롤을\n위해서\n매우 긴\n채팅을\n일부러\n생성\n함', sendTime: DateTime(2023, 7, 8, 12, 20, 35, 50), isCheck: true),
  ChatData(chatId: 13, isSender: false, message: '스크롤을\n위해서\n매우 긴\n채팅을\n일부러\n생성\n함', sendTime: DateTime(2023, 7, 8, 12, 20, 40, 50), isCheck: true),
  ChatData(chatId: 14, isSender: false, message: '스크롤을\n위해서\n매우 긴\n채팅을\n일부러\n생성\n함', sendTime: DateTime(2023, 7, 8, 12, 21, 40, 50), isCheck: true),
...
List<ChatData> chatDataList_2 = [
  ChatData(chatId: 0, isSender: true, message: '내가 보낸 메시지', sendTime: DateTime(2023, 7, 7, 10, 14, 32, 50), isCheck: true),
];

List<ChatData> chatDataList_3 = [
  ChatData(chatId: 0, isSender: false, message: '상대가 보낸 메시지', sendTime: DateTime(2023, 6, 30, 10, 14, 32, 50), isCheck: true),
];

List<ChatData> chatDataList_4 = [
  ChatData(chatId: 0, isSender: false, message: '해당 페이지에서는 메시지가 길면 말줄임표가 붙게됩니다.', sendTime: DateTime(2022, 12, 8, 10, 14, 32, 50), isCheck: false),
];