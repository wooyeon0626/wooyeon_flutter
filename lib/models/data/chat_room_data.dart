...
List<ChatRoom> chatRoomData = [
  ChatRoom(chatRoomId: 0, isOnline: true, matched: matchProfiles[0], chat: chatDataList),
  ChatRoom(chatRoomId: 1, isOnline: false, matched: matchProfiles[1], chat: chatDataList_2),
  ChatRoom(chatRoomId: 2, isOnline: true, matched: matchProfiles[2], chat: chatDataList_3),
  ChatRoom(chatRoomId: 3, isOnline: false, matched: matchProfiles[3], chat: chatDataList_4),
